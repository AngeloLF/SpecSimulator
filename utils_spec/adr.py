...
def instanciation_adr(params, latitude, lbda_ref):
    ...
    adr = ADR(airmass=airmass, parangle=parangle, temperature=temperature, pressure=pressure, lbdaref=lbda_ref, relathumidity=humidity)
...
def flip_and_rotate_adr_to_image_xy_coordinates(adr_ra, adr_dec, dispersion_axis_angle=0):
    ...
    adr_x, adr_y = flip_and_rotate_radec_vector_to_xy_vector(adr_ra, adr_dec,
                                                             camera_angle=hparameters.OBS_CAMERA_ROTATION,
                                                             flip_ra_sign=hparameters.OBS_CAMERA_RA_FLIP_SIGN,
                                                             flip_dec_sign=hparameters.OBS_CAMERA_DEC_FLIP_SIGN)
